...
full_path_missle = os.path.join(APP_FOLDER, "missle_sprite.png")
full_path_space_ship = os.path.join(APP_FOLDER, "Space Ship.png")
full_path_explosion_se = os.path.join(APP_FOLDER, "explosion_sound")
full_path_firing_se = os.path.join(APP_FOLDER, "firing_sound")
